...
#+RESULTS:
: ~/Dropbox/.org/things/braindump/art/arts.org
...
#+RESULTS:
| i  | Inbox         | entry | (file py/inbox)                                              | #'doct--fill-template | :doct    | (:doct-name Inbox :keys i :file py/inbox :template (* %{todo-state} %? :PROPERTIES: :INIT:       %U :END:) :todo-state 🔀 TODO(t) :create-id t :doct-custom (:todo-state 🔀 TODO(t) :create-id t)) |       |                                                                                                                                                                                                                                                                            |
| m  | Metacog       |       |                                                              |                       |          |                                                                                                                                                                                                    |       |                                                                                                                                                                                                                                                                            |
| mn | MetaNotes     | entry | #'(lambda nil (jethro/olp-current-buffer Metacog Notes))     | #'doct--fill-template | :prepend | t                                                                                                                                                                                                  | :doct | (:doct-name MetaNotes :keys n :type entry :todo-state 🔀 TODO(t) :function (lambda nil (jethro/olp-current-buffer Metacog Notes)) :inherited-keys mn :prepend t :template (* %{todo-state} %? :PROPERTIES: :INIT:       %U :END:) :doct-custom (:todo-state 🔀 TODO(t)))   |
| mq | MetaQuestions | entry | #'(lambda nil (jethro/olp-current-buffer Metacog Questions)) | #'doct--fill-template | :prepend | t                                                                                                                                                                                                  | :doct | (:doct-name MetaQuestions :keys q :type entry :todo-state 🔀 TODO :function (lambda nil (jethro/olp-current-buffer Metacog Questions)) :inherited-keys mq :prepend t :template (* %{todo-state} %? :PROPERTIES: :INIT:       %U :END:) :doct-custom (:todo-state 🔀 TODO)) |
| mt | MetaTodos     | entry | #'(lambda nil (jethro/olp-current-buffer Metacog Todos))     | #'doct--fill-template | :prepend | t                                                                                                                                                                                                  | :doct | (:doct-name MetaTodos :keys t :type entry :todo-state 🔀 TODO :function (lambda nil (jethro/olp-current-buffer Metacog Todos)) :inherited-keys mt :prepend t :template (* %{todo-state} %? :PROPERTIES: :INIT:       %U :END:) :doct-custom (:todo-state 🔀 TODO))         |
...
#+end_export
*** 🔀 TODO 这个时间不知道为何不能同时启动pyim和rime-emacs，只好放弃掉了doom的pyim和init中的pyim
:PROPERTIES:
:INIT:       [2021-01-11 Mon 16:34]
:END:
*** 🔀 TODO 考虑弄个 id 直接插入的函数
:PROPERTIES:
:INIT:       [2021-01-11 Mon 16:22]
:END:
*** 🔀 TODO 我应该弄个从 buffer capture 到 org-mode html 的东西（也可以用 pandoc 到 org-mode 啦，这个更好）
:PROPERTIES:
:INIT:       [2021-01-11 Mon 16:20]
:END:
** Questions
*** 🔀 TODO
:PROPERTIES:
